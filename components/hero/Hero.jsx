...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    if (firstText.current && seconfText.current && slider.current) {
      ...
      // scrolling adjustment for the slider
  ...
  return (
    <main className={Style.mainHero}>
      <Image src={"/images/background.jpg"} fill={true} alt="heroBackground" />
      <div className={Style.slideContainer}>
        <div ref={slider} className={Style.slider}>
          <p ref={firstText}>MERN Developer -</p>
          <p ref={seconfText}>MERN Developer -</p>
        </div>
      </div>
